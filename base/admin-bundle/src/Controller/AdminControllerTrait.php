...
use DomBase\DomAdminBundle\Event\AdminEvents;
...
trait AdminControllerTrait
{
    ...
    {
        $this->dispatch(AdminEvents::PRE_INITIALIZE);
        ...
        $this->dispatch(AdminEvents::POST_INITIALIZE);
    }
    ...
    {
        $this->dispatch(AdminEvents::PRE_LIST);
        ...
        if(isset($this->entity['tree']) && $this->entity['tree'] == true) {
            ...
            $this->dispatch(AdminEvents::POST_LIST, ['paginator' => $paginator]);
    ...
    {
        $this->dispatch(AdminEvents::PRE_EDIT);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->dispatch(AdminEvents::PRE_UPDATE, ['entity' => $entity]);
            $this->executeDynamicMethod('update<EntityName>Entity', [$entity, $editForm]);
            $this->dispatch(AdminEvents::POST_UPDATE, ['entity' => $entity]);

            return $this->redirectToReferrer();
        }

        $this->dispatch(AdminEvents::POST_EDIT);
    ...
    {
        $this->dispatch(AdminEvents::PRE_SHOW);
        ...
        $this->dispatch(AdminEvents::POST_SHOW, [
    ...
    {
        $this->dispatch(AdminEvents::PRE_NEW);
        ...
        if ($newForm->isSubmitted() && $newForm->isValid()) {
            $this->dispatch(AdminEvents::PRE_PERSIST, ['entity' => $entity]);
            $this->executeDynamicMethod('persist<EntityName>Entity', [$entity, $newForm]);
            $this->dispatch(AdminEvents::POST_PERSIST, ['entity' => $entity]);

            return $this->redirectToReferrer();
        }

        $this->dispatch(AdminEvents::POST_NEW, [
            'entity_fields' => $fields,
            'form' => $newForm,
            'entity' => $entity,
        ]);
    ...
    {
        $this->dispatch(AdminEvents::PRE_DELETE);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->dispatch(AdminEvents::PRE_REMOVE, ['entity' => $entity]);
            ...
            $this->dispatch(AdminEvents::POST_REMOVE, ['entity' => $entity]);
        }

        $this->dispatch(AdminEvents::POST_DELETE);
    ...
    {
        $this->dispatch(AdminEvents::PRE_SEARCH);
        ...
        $this->dispatch(AdminEvents::POST_SEARCH, [
            'fields' => $fields,
            'paginator' => $paginator,
        ]);
    ...
    public function exportAction()
    {
        ...
        $this->dispatch(AdminEvents::PRE_EXPORT, [
            'user' => [
        ...
        $fields = $this->entity['list']['fields'];
        $this->dispatch(AdminEvents::POST_LIST, [
            'fields' => $fields,
            'paginator' => $paginator,
        ]);

        $this->dispatch(AdminEvents::POST_EXPORT, [
            'user' => [
                'username' => $user ? $user->getUsername() : null,
                'roles' => $user ? $user->getRoles() : [],
            ],
    ...
    protected function updateEntityProperty($entity, $property, $value)
    {
        ...
        $this->dispatch(AdminEvents::PRE_UPDATE, ['entity' => $entity, 'newValue' => $value]);
        $this->executeDynamicMethod('update<EntityName>Entity', [$entity]);
        $this->dispatch(AdminEvents::POST_UPDATE, ['entity' => $entity, 'newValue' => $value]);
    ...
    protected function findAll($entityClass, $page = 1, $maxPerPage = 15, $sortField = null, $sortDirection = null, $dqlFilter = null)
    {
        ...
        $this->dispatch(AdminEvents::POST_LIST_QUERY_BUILDER, [
    ...
    protected function findBy($entityClass, $searchQuery, array $searchableFields, $page = 1, $maxPerPage = 15, $sortField = null, $sortDirection = null, $dqlFilter = null)
    {
        ...
        $this->dispatch(AdminEvents::POST_SEARCH_QUERY_BUILDER, [
            'query_builder' => $queryBuilder,
    ...
    protected function findFiltered($entity, $entityClass, $page = 1, $maxPerPage = 50, $sortField = null, $sortDirection = null, $dqlFilter = null)
    {
        ...
        $this->dispatch(AdminEvents::POST_LIST_QUERY_BUILDER, array(
            'query_builder' => $queryBuilder,
            'sort_field' => $sortField,
            'sort_direction' => $sortDirection,
        ));
...
//            $this->addFlash('success', $this->get('translator')->transChoice('translator.flash.success', $nbWrittenFiles, ['%nbFiles%' => $nbWrittenFiles], 'EasyAdminPlusBundle'));
            ...
            $this->get('event_dispatcher')->dispatch(AdminEvents::POST_TRANSLATE,
        ...
        // dispatch event
        $this->get('event_dispatcher')->dispatch(AdminEvents::PRE_TRANSLATE,
            new GenericEvent($domain, [
                'domain' => $domain,
                'user' => [
                    'username' => $user ? $user->getUsername() : null,
