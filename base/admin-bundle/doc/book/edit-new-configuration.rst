...
.. code-block:: yaml
    ...
    easy_admin:
        design:
            ...
            form_theme: '@DomAdmin/form/bootstrap_4.html.twig'
...
* ``@DomAdmin/default/new``, renders the page where new entities are created;
* ``@DomAdmin/default/edit``, renders the page where entity contents are edited;
...
.. code-block:: twig
    ...
    {% extends '@DomAdmin/default/new.html.twig' %}
