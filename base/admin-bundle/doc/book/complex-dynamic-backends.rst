...
.. code-block:: php
    ...
    use DomBase\DomAdminBundle\Controller\EasyAdminController;
...
EasyAdmin events are defined in the ``DomBase\DomAdminBundle\Event\EasyAdminEvents`` class.
...
Twig Template Path: ``@DomAdmin/page/login.html.twig``
...
Twig Template Path: ``@DomAdmin/page/content.html.twig``
...
Twig Template Path: ``@DomAdmin/page/blank.html.twig``
