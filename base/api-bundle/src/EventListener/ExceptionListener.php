...
namespace DomBase\DomApiBundle\EventListener;

use DomBase\DomApiBundle\Exception\BaseException;
use DomBase\DomApiBundle\Exception\FlattenException;
