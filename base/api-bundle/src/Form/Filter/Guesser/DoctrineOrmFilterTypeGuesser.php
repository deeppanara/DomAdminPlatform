...
namespace DomBase\DomApiBundle\Form\Filter\Guesser;

use Doctrine\DBAL\Types\Type;
use Doctrine\ORM\Mapping\ClassMetadataInfo;
use DomBase\DomApiBundle\Form\Filter\Type\ArrayFilterType;
use DomBase\DomApiBundle\Form\Filter\Type\BooleanFilterType;
use DomBase\DomApiBundle\Form\Filter\Type\ComparisonFilterType;
use DomBase\DomApiBundle\Form\Filter\Type\DateTimeFilterType;
use DomBase\DomApiBundle\Form\Filter\Type\EntityFilterType;
use DomBase\DomApiBundle\Form\Filter\Type\TextFilterType;
...
class DoctrineOrmFilterTypeGuesser extends DoctrineOrmTypeGuesser
{
    private static $defaultOptions = [
        'translation_domain' => 'DomApiBundle',
    ];
