...
namespace DomBase\DomApiBundle\Form\Util;

use DomBase\DomApiBundle\Form\Type\EasyAdminAutocompleteType;
use DomBase\DomApiBundle\Form\Type\EasyAdminDividerType;
use DomBase\DomApiBundle\Form\Type\EasyAdminFormType;
use DomBase\DomApiBundle\Form\Type\EasyAdminGroupType;
use DomBase\DomApiBundle\Form\Type\EasyAdminSectionType;
...
final class FormTypeHelper
{
    private static $nameToClassMap = [
        ...
        'domapi' => EasyAdminFormType::class,
        'domapi_autocomplete' => EasyAdminAutocompleteType::class,
        'domapi_divider' => EasyAdminDividerType::class,
        'domapi_group' => EasyAdminGroupType::class,
        'domapi_section' => EasyAdminSectionType::class,
