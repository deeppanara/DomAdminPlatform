...
use DomBase\DomApiBundle\Form\EventListener\EasyAdminAutocompleteSubscriber;
...
class EasyAdminAutocompleteType extends AbstractType implements DataMapperInterface
{
    ...
    public function finishView(FormView $view, FormInterface $form, array $options)
    {
        ...
        \array_splice($view['autocomplete']->vars['block_prefixes'], -1, 0, 'domapi_autocomplete_inner');
    }
