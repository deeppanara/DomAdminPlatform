...
namespace EasyCorp\Bundle\DomAdminBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('dom_admin');
        $rootNode = $this->getRootNode($treeBuilder, 'dom_admin');
                ...
                ->arrayNode('design')
                    ...
                    ->children()
                        ...
                        ->variableNode('form_theme')
                            ->defaultValue(['@DomAdmin/form/bootstrap_4.html.twig'])
                            ->treatNullLike(['@DomAdmin/form/bootstrap_4.html.twig'])
