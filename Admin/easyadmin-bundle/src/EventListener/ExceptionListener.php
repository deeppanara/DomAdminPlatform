...
namespace EasyCorp\Bundle\DomAdminBundle\EventListener;

use EasyCorp\Bundle\DomAdminBundle\Exception\BaseException;
use EasyCorp\Bundle\DomAdminBundle\Exception\FlattenException;
