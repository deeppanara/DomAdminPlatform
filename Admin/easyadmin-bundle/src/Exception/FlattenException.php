...
namespace EasyCorp\Bundle\DomAdminBundle\Exception;
...
class FlattenException extends BaseFlattenException
{
    ...
    public static function create(\Exception $exception, $statusCode = null, array $headers = [])
    {
        if (!$exception instanceof BaseException) {
            throw new \RuntimeException(\sprintf('You should only try to create an instance of "%s" with a "EasyCorp\Bundle\DomAdminBundle\Exception\BaseException" instance, or subclass. "%s" given.', __CLASS__, \get_class($exception)));
        }
