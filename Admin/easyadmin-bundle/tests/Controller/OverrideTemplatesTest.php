...
class OverrideTemplatesTest extends AbstractTestCase
{
    ...
    public function testConfigurationOfOverriddenTemplates()
    {
        ...
        $this->assertSame('@DomAdmin/default/new.html.twig', $backendConfig['design']['templates']['new']);
        ...
        $this->assertSame('@DomAdmin/default/new.html.twig', $entityConfig['templates']['new']);
