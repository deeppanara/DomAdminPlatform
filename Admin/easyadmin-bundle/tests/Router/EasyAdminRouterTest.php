...
namespace EasyCorp\Bundle\DomAdminBundle\Tests\Router;

use AppTestBundle\Entity\FunctionalTests\Product;
use EasyCorp\Bundle\DomAdminBundle\Router\EasyAdminRouter;
...
final class EasyAdminRouterTest extends AbstractTestCase
{
     ...
     *
     * @expectedException \EasyCorp\Bundle\DomAdminBundle\Exception\UndefinedEntityException
     */
