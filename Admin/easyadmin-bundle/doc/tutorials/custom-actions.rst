...
.. code-block:: php
    ...
    use EasyCorp\Bundle\DomAdminBundle\Controller\AdminController as BaseAdminController;
    // ...
...
(``@DomAdmin/default/action.html.twig``) which displays the icon and label of
...
.. code-block:: twig
    ...
    {% if item.stock < 10 %}
        {{ include('@DomAdmin/default/action.html.twig') }}
    {% endif %}
